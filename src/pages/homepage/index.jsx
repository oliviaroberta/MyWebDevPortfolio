...
const HomepageInteractivePortfolioExperience = () => {
  return (
    <>
      <Helmet>
        <title>OLIVIA-ROBERTA - Frontend Developer Portfolio</title>
        <meta 
          name="description" 
          content="Frontend Artisan crafting pixel-perfect React applications with design sensibility. Specializing in TypeScript, Next.js, and creating beautiful digital experiences that perform flawlessly." 
        />
        <meta name="keywords" content="React Developer, Frontend Developer, TypeScript, Next.js, UI/UX Design, Web Development, Portfolio" />
        <meta property="og:title" content="OLIVIA-ROBERTA- Beautiful Code, Beautiful Experiences" />
        <meta property="og:description" content="Frontend Artisan crafting pixel-perfect implementations with design sensibility" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="OLIVIA-ROBERTA- Beautiful Code, Beautiful Experiences" />
        <meta name="twitter:description" content="Frontend Artisan crafting pixel-perfect implementations with design sensibility" />
...
export default HomepageInteractivePortfolioExperience;