...
const AboutPersonalJourneyTechnicalStory = () => {
  return (
    <>
      <Helmet>
        <title>About </title>
        <meta 
          name="description" 
          content="Discover the personal journey and technical story. From design curiosity to frontend mastery, learn about the passion driving beautiful code and experiences." 
        />
        <meta name="keywords" content="About, Personal Journey, Technical Story, Frontend Developer, React Developer, Design to Code" />
        <meta property="og:title" content="About - Personal Journey & Technical Story | Olivia-Roberta" />
        <meta property="og:description" content="Where Design Meets Code, Magic Happens - Discover the story behind the passion" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About - Personal Journey & Technical Story" />
        <meta name="twitter:description" content="Where Design Meets Code, Magic Happens - Discover the story behind the passion" />
        <link rel="canonical" href="/about-personal-journey-technical-story" />
      </Helmet>
...
export default AboutPersonalJourneyTechnicalStory;
