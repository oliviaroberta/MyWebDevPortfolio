...
const SkillsServicesExpertiseBreakdown = () => {
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Comprehensive breakdown of React development skills and services. From component crafting to system building, discover expertise in modern frontend development." 
        />
        <meta name="keywords" content="React Developer, Frontend Services, TypeScript, Next.js, Design Systems, Web Development Skills" />
        <meta property="og:title" content="Skills & Services - Expertise Breakdown | Olivia-Roberta" />
        <meta property="og:description" content="Expert React development services with transparent pricing and value-based partnerships" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Skills & Services - Expertise Breakdown" />
        <meta name="twitter:description" content="Expert React development services with transparent pricing and value-based partnerships" />
        <link rel="canonical" href="/skills-services-expertise-breakdown" />
      </Helmet>
 ...
 <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground font-inter mb-6 max-w-2xl mx-auto">
                Let's discuss how my expertise can help bring your vision to life with beautiful, performant code.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="/about" 
                  className="inline-flex items-center space-x-2 bg-secondary/10 hover:bg-secondary/20 text-secondary border border-secondary/20 px-6 py-3 rounded-lg font-inter font-medium transition-colors duration-300"
                >
                ...
                <a 
                  href="/portfolio" 
                  className="inline-flex items-center space-x-2 bg-accent hover:bg-accent/90 text-accent-foreground px-6 py-3 rounded-lg font-inter font-medium transition-colors duration-300"
                >
...
export default SkillsServicesExpertiseBreakdown;